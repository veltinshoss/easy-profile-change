...
import static de.pepping.android.ringtone.Constants.PREF_LIGHT_SENSOR;
...
public class BrightnessPrefs extends PreferenceActivity implements OnPreferenceClickListener, OnClickListener {
	...
	private GuiceNumberGeneratorApplication getApp() {
		return (GuiceNumberGeneratorApplication) getApplication();
	}
